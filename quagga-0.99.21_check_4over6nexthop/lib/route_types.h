...
#define ZEBRA_ROUTE_OPENFLOW             14//sangmeng add for identify openflow route 20180705
#define ZEBRA_ROUTE_MAX                  15

#define SHOW_ROUTE_V4_HEADER \
  "Codes: C - connected, S - static, R - RIP, O - OSPF, B - BGP, F - OPENFLOW,%s" \
  "       > - selected route, * - FIB route%s%s", \
  VTY_NEWLINE, VTY_NEWLINE, VTY_NEWLINE
#define SHOW_ROUTE_V6_HEADER \
  "Codes: C - connected, S - static, R - RIPng, O - OSPFv6, B - BGP, F - OPENFLOW,%s" \
  "       > - selected route, * - FIB route%s%s", \
  VTY_NEWLINE, VTY_NEWLINE, VTY_NEWLINE
#define SHOW_C_ROUTE_V6_HEADER \
  "Codes: C - connected, S - static, R - RIPng, O - OSPFv6, B - BGP, F - SDN,%s" \
  "       > - selected route, * - FIB route%s%s", \
  VTY_NEWLINE, VTY_NEWLINE, VTY_NEWLINE
...
static const struct zebra_desc_table route_types[] =
{
    ...
    DESC_ENTRY	(ZEBRA_ROUTE_OPENFLOW,	 "openflow",	'F' ),
};
#undef DESC_ENTRY
