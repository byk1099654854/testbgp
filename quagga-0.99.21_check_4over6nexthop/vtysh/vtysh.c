...
DEFUNSH (VTYSH_INTERFACE,
         vtysh_interfacegigabitethernet,
         vtysh_interfacegigabitethernet_cmd,
...
DEFUNSH (VTYSH_INTERFACE,
         vtysh_no_interfacegigabitethernet,
         vtysh_no_interfacegigabitethernet_cmd,
...
// install_element (ISIS_NODE, &vtysh_exit_isisd_cmd);
    ...
    install_element (CONFIG_NODE, &vtysh_interfacegigabitethernet_cmd);
    install_element (CONFIG_NODE, &vtysh_no_interfacegigabitethernet_cmd);
