    ...
    default:
        ...
        //added for 4over6 20130409
            ...
            config = config_get (VTY_NODE, line);
                  ...
                  || (strncmp (line, "ip server forwarding",
                               strlen ("ip server forwarding")) == 0)
                )
        ...
        //added for ivi&nat64 20130409
                 ...
                 || (strncmp (line, "dns64",
                              strlen ("dns64")) == 0)
                 || (strncmp (line, "section-engine",
                              strlen ("section-engine")) == 0)
                 || (strncmp (line, "processing-engine",
                              strlen ("processing-engine")) == 0)
                 || (strncmp (line, "flow-engine",
                              strlen ("flow-engine")) == 0))
            config = config_get (IP_NODE, line);
        else if ((strncmp (line, "header-compression",
                           strlen ("header-compression")) == 0))
            config = config_get (IP_NODE, line);

        else if ((strncmp (line, "policy-route",
                           strlen ("policy-route")) == 0))
            config = config_get (IP_NODE, line);
        else if ((strncmp (line, "flowsp",
                           strlen ("flowsp")) == 0))
            config = config_get (IP_NODE, line);
        else if ((strncmp (line, "access-ipv6",
                           strlen ("access-ipv6")) == 0))
            config = config_get (IP_NODE, line);
