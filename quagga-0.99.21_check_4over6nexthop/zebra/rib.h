...
#define RIB_ROUTE_QUEUED(x)	(1 << (x))
    ...
    //sangmeng add for indentify customize route
    /*Type for customize route*/
    int type_customize;
...
//extern int static_add_ipv4_customize (struct prefix *p, struct in_addr *gate, const char *ifname, u_char flags, u_char distance, u_int32_t vrf_id);
extern int zebra_rib_add_ipv4_customize (char *routetablename, struct prefix *p, struct in_addr *gate, const char *ifname, u_char distance, u_int32_t vrf_id);

extern int
static_delete_ipv4 (struct prefix *p, struct in_addr *gate, const char *ifname,
                    u_char distance, u_int32_t vrf_id);

//extern int static_delete_ipv4_customize (struct prefix *p, struct in_addr *gate, const char *ifname, u_char distance, u_int32_t vrf_id);
extern int zebra_rib_del_ipv4_customize (char *routetablename, struct prefix *p, struct in_addr *gate, const char *ifname, u_int32_t vrf_id);
...
static_add_ipv6 (struct prefix *p, u_char type, struct in6_addr *gate,
                 ...
                 u_int32_t vrf_id);
//extern int
//static_add_ipv6_customize (struct prefix *p, u_char type, struct in6_addr *gate,
//                          const char *ifname, u_char flags, u_char distance,
//                         u_int32_t vrf_id);
//sangmeng add for suctomize route
//extern int zebra_rib_add_ipv6_customize (char *routetablename, struct prefix *p, struct in6_addr *gate, const char *ifname, u_char distance, u_int32_t vrf_id);
extern int zebra_rib_add_ipv6_customize (char *routetablename, struct prefix *p, struct in6_addr *gate, const char *ifname, u_char distance, u_int32_t vrf_id, const char *describe,uint8_t action);
...
//extern int
//static_delete_ipv6_customize (struct prefix *p, u_char type, struct in6_addr *gate, const char *ifname, u_char distance, u_int32_t vrf_id);

//sangmeng add for suctomize route
extern int zebra_rib_delete_ipv6_customize (char *routetablename, struct prefix *p, struct in6_addr *gate, const char *ifname, u_int32_t vrf_id);
//sangmeng add for suctomize route
extern void install_customize_route(void);
extern void zebra_server_process_msg(char *msg,int len);
